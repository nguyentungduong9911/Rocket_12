...
-- Question1: lấy ra tất cả phòng ban
SELECT * FROM Department;

-- Question2: lấy ra id của phòng ban có tên là "Sale"
SELECT DepartmentID FROM Department WHERE DepartmentName ="Sale";

-- Question3: lấy ra thông tin account có full name dài nhất
...
-- Question 11: Viết lệnh để lấy ra tất cả các Develop
...
-- Question 14: Viết lệnh để lấy ra danh sách câu hỏi được sử dụng trong đề thi nhiều nhất
